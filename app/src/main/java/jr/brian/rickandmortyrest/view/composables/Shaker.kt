...
class ShakeController {
    ...
    fun shake(shakeConfig: ShakeConfig = ShakeConfig.horizontalConfig()) {
...
data class ShakeConfig(
    ...
    companion object {
        fun horizontalConfig() = ShakeConfig(
            iterations = 4,
            intensity = 2_000f,
            rotateY = 15f,
            translateX = 40f,
...
fun Modifier.addShakeController(shakeController: ShakeController) = composed {
